   ...
   if (isset($_POST['update'])) {
   	...
   	$query = "UPDATE patient SET patient_name='$fullname' , patient_email='$email', patient_password='$password' , patient_gender='$gender',patient_age='$age' WHERE patient_id = {$_SESSION['patient_id']}";

		//preform query
   	mysqli_query($conn,$query);
    /*echo $query;
    die;*/
   	echo "<script> window.top.location='patient_profile.php' </script>";
   }
